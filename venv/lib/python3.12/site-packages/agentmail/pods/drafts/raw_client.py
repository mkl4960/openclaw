...
class RawDraftsClient:
    ...
    def list(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"v0/pods/{jsonable_encoder(pod_id)}/drafts",
    ...
    def get(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v0/pods/{jsonable_encoder(pod_id)}/drafts/{jsonable_encoder(draft_id)}",
            base_url=self._client_wrapper.get_environment().http,
            method="GET",
            request_options=request_options,
        )
    ...
    def get_attachment(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v0/pods/{jsonable_encoder(pod_id)}/drafts/{jsonable_encoder(draft_id)}/attachments/{jsonable_encoder(attachment_id)}",
            base_url=self._client_wrapper.get_environment().http,
            method="GET",
            request_options=request_options,
        )
