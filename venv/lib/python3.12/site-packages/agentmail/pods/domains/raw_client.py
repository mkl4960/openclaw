...
class RawDomainsClient:
    ...
    def get_zone_file(
        ...
        with self._client_wrapper.httpx_client.stream(
            f"v0/pods/{jsonable_encoder(pod_id)}/domains/{jsonable_encoder(domain_id)}/zone-file",
            base_url=self._client_wrapper.get_environment().http,
            method="GET",
            request_options=request_options,
        ) as _response:
    ...
    def verify(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v0/pods/{jsonable_encoder(pod_id)}/domains/{jsonable_encoder(domain_id)}/verify",
            base_url=self._client_wrapper.get_environment().http,
            method="POST",
            request_options=request_options,
        )
